...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fl_langtranslate/4.5.x-4.x.x/class.ux_t3lib_tcemain.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fl_langtranslate/4.5.x-4.x.x/class.ux_t3lib_tcemain.php']);
}
?>